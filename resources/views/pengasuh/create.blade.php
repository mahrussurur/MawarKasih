...
<div class="p-6 bg-gray-100 min-h-screen flex justify-center items-start">
    ...
    <div class="w-full max-w-3xl bg-white rounded-xl shadow-md p-8 border border-gray-200 mt-4">
        <h2 class="text-2xl font-bold mb-6 text-gray-800">Tambah Data Pengasuh</h2>
        ...
        <form action="{{ route('pengasuh.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="jabatan" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
            </div>
            ...
            <div class="mb-5">
                ...
                <input type="text" name="no_hp" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
            </div>
